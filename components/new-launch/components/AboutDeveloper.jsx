          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                A part of the prestigious Mahindra Group of Companies, Mahindra Lifespaces is a real estate firm that builds quality residences, industrial complexes, and integrated cities. With a presence in 9 cities, the company has coupled its innovative practices with sustainable technologies to deliver 43 residential projects in India.
              </p>
            </div>

...
import {
  Dumbbell, Waves, Trees, Gamepad2, Landmark, Baby, Footprints, Trophy
} from 'lucide-react'
...
const newAmenities = [
  { icon: Footprints, title: 'JOGGING TRACK', desc: '' },
  { icon: Baby,       title: "KIDS' PLAY AREA", desc: '' },
  { icon: Dumbbell,   title: 'FULLY EQUIPPED GYMNASIUM', desc: '' },
  { icon: Trees,      title: 'LANDSCAPED GARDEN & POOL', desc: '' },
  { icon: Gamepad2,   title: 'INDOOR GAMES ROOM', desc: '' },
  { icon: Trophy,     title: 'MULTI-PURPOSE SPORTS COURT', desc: '' },
  { icon: Landmark,   title: 'BANQUET HALL', desc: '' },
  { icon: Waves,      title: 'GRAND SWIMMING POOL', desc: '' },
]

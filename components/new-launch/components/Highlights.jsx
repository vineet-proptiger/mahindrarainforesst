...
const highlights = [
  { title: '', desc: '37 Acres of Lush Green Rainforest-Themed Development', Icon: IconTrees },
  { title: '', desc: 'Iconic G+9P+45 Floors High-Rise Living', Icon: IconBuilding },
  { title: '', desc: 'EOI on 2 BHK at just ₹2.70 Lakhs', Icon: IconHome },
  { title: '', desc: 'EOI on 3 BHK at just ₹3.60 Lakhs', Icon: IconHome },
  { title: '', desc: 'Instant Benefits On Spot-Booking', Icon: IconLightning },
  { title: '', desc: 'Premium Clubhouse & World-Class Amenities', Icon: IconSmart },
  { title: '', desc: 'Spa, Infinity Pool & Wellness Zones', Icon: IconWaves },
  { title: '', desc: 'Close to BKC, Eastern Express Highway & Kanjurmarg Station', Icon: IconMountain },
]

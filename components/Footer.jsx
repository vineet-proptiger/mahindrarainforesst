  ...
  <footer style={{ background: 'var(--color-dark)', color: '#fff' }}>
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '56px 24px 32px', textAlign: 'center' }}>
      ...
      <p style={{ fontSize: '13px', color: 'var(--color-gold)', fontFamily: F_JOST, fontWeight: '700', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '12px' }}>
        New Launch — Kanjurmarg, Mumbai. By Mahindra Lifespaces.
      </p>
      ...
      <p style={{ fontSize: '15px', color: '#bbb', fontFamily: F_SANS, lineHeight: 1.8, marginBottom: '32px', textAlign: 'justify' }}
        ...
        Mahindra Rainforest is a premium residential development by Mahindra Lifespaces, offering luxurious 2 &amp; 3 BHK apartments starting ₹2.10 Cr* at Kanjurmarg, Mumbai. Spread across 37 acres and rising to G+9P+45 floors, with lush green landscapes, world-class amenities, and excellent connectivity to BKC, Eastern Express Highway and Kanjurmarg Railway Station — Mahindra Rainforest is crafted for those who seek a life of comfort, elegance, and modern living in Mumbai.
      </p>
    </div>

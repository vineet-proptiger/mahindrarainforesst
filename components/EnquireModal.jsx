    ...
    >
      ...
      >
        ...
        {/* <div className="hidden sm:block sm:w-[44%] shrink-0 relative" style={{ background: '#0d1117', minHeight: '100%' }}>
          <Image src={popupImage} alt="Mahindra Rainforest" fill className="object-cover" sizes="(max-width: 768px) 0vw, 45vw" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 text-white z-10">
            <p className="text-[10px] font-semibold tracking-[3px] uppercase opacity-80 mb-1" style={{ fontFamily: F_SANS, color: 'var(--color-gold)' }}>Mahindra Rainforest</p>
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          {/* <div className="sm:hidden w-full h-56 relative shrink-0">
            <Image src={popupImage} alt="Mahindra Rainforest" fill className="object-cover" style={{ objectPosition: 'top' }} sizes="100vw" />
            ...
            <div className="absolute bottom-3 left-4 text-white z-10">
              <p className="text-[9px] uppercase tracking-[2px] opacity-80" style={{ fontFamily: F_SANS }}>Mahindra Rainforest</p>

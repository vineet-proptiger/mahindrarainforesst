...
const OPEN_VIEWS = [
  ...
  { dir: '15m', label: 'BKC', sub: '15 Mins Drive' },
  { dir: '20m', label: 'Powai IT Hub', sub: '20 Mins Away' },
  { dir: '25m', label: 'International Airport', sub: '25 Mins Drive' },
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Kanjurmarg, Mumbai — New Launch</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Mahindra Rainforest <span style={{ color: 'var(--color-gold)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            ...
            >
              <Image src={overviewImage} alt="Mahindra Rainforest" fill className="object-cover object-top"

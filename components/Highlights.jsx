...
const highlights = [
  {
    text: '37 Acres of Lush Green Rainforest-Themed Development',
    icon: <Trees {...highlightIconProps} />,
  },
  {
    text: 'Iconic G+9P+45 Floors High-Rise Living',
    icon: <Trophy {...highlightIconProps} />,
  },
  {
    text: 'EOI on 2 BHK at just ₹2.70 Lakhs',
    icon: <BookOpen {...highlightIconProps} />,
  },
  {
    text: 'EOI on 3 BHK at just ₹3.60 Lakhs',
  ...
  {
    text: 'Close to BKC, Eastern Express Highway & Kanjurmarg Station',
  ...
  <section id="highlights" style={{
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        }}>Kanjurmarg, Mumbai — Project Excellence</span>
        <h2 style={{
          fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
          color: '#111827', margin: 0, letterSpacing: '-0.01em',
        }}>
          Project Highlights:{' '}
          <span style={{ color: 'var(--color-gold)' }}>Mahindra Rainforest</span>
        </h2>
